...
TImageInfo* CRenderEngine::LoadImage(STRINGorID bitmap, HBITMAP hBitmap, int nWidth, int nHeight, bool bAlphaChannel/*=false*/)
{
   // bool bAlphaChannel = false;	
...
void CRenderEngine::DrawColor(HDC hDC, const RECT& rc, DWORD color)
{
    ...
    else
    {
		...
		*pDest |= 0xFF000000;
        ...
        RECT rcCorners = {0};
        DrawImage(hDC, hBitmap, rc, rc, rcBmpPart, rcCorners, true, color >> 24);
