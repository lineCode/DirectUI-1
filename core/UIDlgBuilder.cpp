    ...
    for (CMarkupNode node = pRoot->GetChild() ; node.IsValid(); node = node.GetSibling())
	{
        ...
        else 
		{
            ...
            case 6:
                ...
                else if (_tcscmp(pstrClass, DUI_CTR_HOTKEY) == 0)         pControl = new CHotKeyCtrlUI;
                break;
            case 7:
            ...
            case 8:
				...
				else if (_tcscmp(pstrClass, DUI_CTR_LABELEX2)== 0)		  pControl = new CLabelEx2;
                break;
            case 9:
            ...
            case 10:
				...
				else if (_tcscmp(pstrClass, DUI_CTR_EDITSLIDER) == 0)	  pControl = new CEditSliderUI;
                break;
			case 11:
				if (_tcscmp(pstrClass, DUI_CTR_CHILDLAYOUT) == 0)		  pControl = new CChildLayoutUI;
				else if (_tcscmp(pstrClass, DUI_CTR_EDITSPIN) == 0)	  pControl = new CEditSpinVarUI;
				break;
			case 12:
